...
(function() {
  var EncKeyManager, KeyManager, Nonce20, PerTeamKeyBox, PerTeamKeyBoxes, PerTeamSecretKeySet, PerTeamSecretKeys, PerUserSecretKeys, PerXSecretKeys, RatchetBlindingKey, RatchetBlindingKeySet, createHash, createHmac, derive_key, iced, kb, kbpgp, kdf, make_esc, nacl, pack, unpack, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/max/src/keybase/node-forge-sigchain/src/teamlib.iced",
  ...
  exports.PerTeamKeyBox = PerTeamKeyBox = (function() {
    ...
    PerTeamKeyBox.prototype.encrypt = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          _this.box = (unpack(Buffer.from(box, 'base64'))).body.ciphertext;
  ...
  exports.RatchetBlindingKey = RatchetBlindingKey = (function() {
    function RatchetBlindingKey(_arg) {
      this.version = _arg.version, this.ratchet = _arg.ratchet, this.blinding_key = _arg.blinding_key, this.link_id = _arg.link_id, this.seqno = _arg.seqno, this.chain_type = _arg.chain_type;
    }

    RatchetBlindingKey.prototype.encode_body = function() {
      return {
        h: this.link_id,
        s: this.seqno,
        t: this.chain_type
    ...
    RatchetBlindingKey.prototype.encode_ratchet = function() {
      return {
        k: this.blinding_key,
        r: this.ratchet
      };
    ...
    RatchetBlindingKey.prototype.encode = function() {
      return {
        b: this.encode_body(),
        r: this.encode_ratchet(),
        v: this.version
      };
    };

    RatchetBlindingKey.generate = function(_arg) {
      var blinding_key, chain_type, link_id, prng, ret, seqno;
      link_id = _arg.link_id, seqno = _arg.seqno, chain_type = _arg.chain_type, prng = _arg.prng;
      blinding_key = prng(32);
      ret = new RatchetBlindingKey({
    ...
    RatchetBlindingKey.prototype.compute = function() {
      var h, ret;
      h = createHmac('sha512', this.blinding_key);
      h.update(pack(this.encode_body()));
      ret = h.digest().slice(0, 32);
      return ret;
    };

    RatchetBlindingKey.prototype.id = function() {
      return this.ratchet.toString('hex');
    };

    return RatchetBlindingKey;

  })();

  exports.RatchetBlindingKeySet = RatchetBlindingKeySet = (function() {
    function RatchetBlindingKeySet(_arg) {
      this.d = _arg.d;
    }

    RatchetBlindingKeySet.generate = function(ratchets) {
      var d, r, _i, _len;
      d = {};
      for (_i = 0, _len = ratchets.length; _i < _len; _i++) {
        r = ratchets[_i];
        d[r.id()] = r;
      }
      return new RatchetBlindingKeySet({
        d: d
      });
    };

    RatchetBlindingKeySet.prototype.encode = function() {
      var arr, v, _;
      arr = (function() {
        var _ref3, _results;
        _ref3 = this.d;
