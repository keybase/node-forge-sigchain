...
(function() {
  ...
  Team = (function() {
    ...
    Team.prototype._forge_link_helper_hidden = function(_arg, cb) {
      var bundle, ctime, esc, existing_hook, f, hash_meta, inner, km_sig, link_desc, link_entry, link_id, outer, parent_chain_tail, prev, proof, proof_gen_out, proof_klass, raw, seqno, sig_arg, sig_arg_kms, sig_arg_team, user, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref4, _ref5, _ref6, _ref7;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      if ((f = (_ref7 = link_desc.corruptors) != null ? _ref7.reverse_sig_inputs : void 0) != null) {
      ...
      (function(_this) {
        ...
        return function() {
          ...
          if ((f = (_ref8 = link_desc.corruptors) != null ? _ref8.sig3_corrupt_outer : void 0) != null) {
          ...
          if ((_ref9 = link_desc.corruptors) != null) {
            if (typeof _ref9.sig3_bundle === "function") {
              _ref9.sig3_bundle({
                bundle: bundle
              });
            }
    ...
    Team.prototype._make_ratchet = function(_arg) {
      var arg, hidden, link_desc, r, _ref4;
      hidden = _arg.hidden, link_desc = _arg.link_desc;
      arg = {
        link_id: maybe_unhex(hidden.link_id),
        seqno: ((_ref4 = link_desc.corruptors) != null ? _ref4.ratchet_seqno : void 0) || hidden.for_client.seqno,
