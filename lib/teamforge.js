...
(function() {
  ...
  Team = (function() {
    ...
    Team.prototype._forge_link_helper_hidden = function(_arg, cb) {
      var bundle, ctime, esc, existing_hook, f, hash_meta, inner, km_sig, link_desc, link_entry, link_id, outer, parent_chain_tail, prev, proof, proof_gen_out, proof_klass, raw, reverse_sig_inputs, seqno, sig3_patch_inner, sig3_patch_outer, sig_arg, sig_arg_kms, sig_arg_team, user, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
        ...
        return function() {
          ...
          link_entry = {
            ...
            for_client: {
              ...
              hidden_is_fresh: (link_desc.hidden_is_fresh != null ? link_desc.hidden_is_fresh : true)
            }
          };
