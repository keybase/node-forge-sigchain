...
(function() {
  var LinkIDGen, PerTeamKeyBox, PerTeamKeyBoxes, PerTeamSecretKeySet, PerTeamSecretKeys, PerUserSecretKeys, SHA256, Team, TeamForge, UnsupportedLinkCritical, UnsupportedLinkIgnoreIfUnsupported, User, akatch, assert, athrow, constants, createHash, iced, kbpgp, make_esc, make_prng, prng, proofs, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  Team = (function() {
    ...
    Team.prototype.forge_link = function(_arg, cb) {
      ...
      switch (link_desc.type) {
        ...
        case 'unsupported_critical':
          return this._forge_link_unsupported_critical({
            link_desc: link_desc,
            user: user
          }, cb);
        case 'unsupported_ignore':
          return this._forge_link_unsupported_ignore({
            link_desc: link_desc,
            user: user
          }, cb);
        default:
    ...
    Team.prototype._forge_link_unsupported_critical = function(_arg, cb) {
      var esc, link_desc, proof_klass, sig_arg_team, user, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      link_desc = _arg.link_desc, user = _arg.user;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/miles/go/src/github.com/keybase/node-forge-sigchain/src/teamforge.iced",
            funcname: "Team._forge_link_unsupported_critical"
          });
          _this._forge_link_helper({
            link_desc: link_desc,
            user: user,
    ...
    Team.prototype._forge_link_unsupported_ignore = function(_arg, cb) {
      var esc, link_desc, proof_klass, sig_arg_team, user, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      link_desc = _arg.link_desc, user = _arg.user;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/miles/go/src/github.com/keybase/node-forge-sigchain/src/teamforge.iced",
            funcname: "Team._forge_link_unsupported_ignore"
          });
          _this._forge_link_helper({
            link_desc: link_desc,
            user: user,
  ...
  UnsupportedLinkCritical = (function(_super) {
    __extends(UnsupportedLinkCritical, _super);

    function UnsupportedLinkCritical() {
      return UnsupportedLinkCritical.__super__.constructor.apply(this, arguments);
    }

    UnsupportedLinkCritical.prototype._type = function() {
      return "team.unsupported_critical";
    };

    UnsupportedLinkCritical.prototype._type_v2 = function() {
      return 1337;
    };

    return UnsupportedLinkCritical;

  })(proofs.team.TeamBase);

  UnsupportedLinkIgnoreIfUnsupported = (function(_super) {
    __extends(UnsupportedLinkIgnoreIfUnsupported, _super);

    function UnsupportedLinkIgnoreIfUnsupported() {
      return UnsupportedLinkIgnoreIfUnsupported.__super__.constructor.apply(this, arguments);
    }

    UnsupportedLinkIgnoreIfUnsupported.prototype._type = function() {
      return "team.unsupported_ignore";
    };

    UnsupportedLinkIgnoreIfUnsupported.prototype._type_v2 = function() {
      return 1338;
    };

    UnsupportedLinkIgnoreIfUnsupported.prototype._ignore_if_unsupported = function() {
      return true;
    };

    return UnsupportedLinkIgnoreIfUnsupported;
