...
(function() {
  ...
  Team = (function() {
    ...
    Team.prototype._forge_link_helper = function(_arg, cb) {
      var b4, esc, hash_meta, km_sig, link_desc, link_entry, link_id, prev, proof, proof_gen_out, proof_klass, seqno, sig_arg, sig_arg_kms, sig_arg_team, user, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3, _ref4, _ref5, _ref6, _ref7;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      seqno = link_desc.seqno || (this.links.length + 1);
    ...
    Team.prototype._forge_link_root = function(_arg, cb) {
      var boxes, d, esc, link_desc, proof_klass, ptsk, receiver_puk_kms, receiver_user, sender_puk_kms, sig_arg_kms, sig_arg_team, sks, sks_post, user, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      link_desc = _arg.link_desc, user = _arg.user;
