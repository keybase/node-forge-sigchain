...
(function() {
  ...
  Team = (function() {
    ...
    Team.prototype._new_team_key = function(_arg, cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      link_desc = _arg.link_desc, user = _arg.user, but_dont_save = _arg.but_dont_save, chain_type = _arg.chain_type;
    ...
    Team.prototype._forge_link_rotate_key_hidden = function(_arg, cb) {
      var chain_type, esc, generation, link_desc, proof_klass, sig_arg_kms, sig_arg_team, user, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      link_desc = _arg.link_desc, user = _arg.user;
