...
(function() {
  var Forge, Key, Keyring, Link, SIG_ID_SUFFIX, UID_HEX_LEN, UID_SUFFIX, add_client, akatch, athrow, btcjs, constants, createHash, generate_proof, generate_v1_with_corruption, generate_v2_with_corruption, iced, json_stringify_sorted, kbpgp, make_esc, pgp_utils, prng, proofs, unix_time, username_to_uid, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  generate_v2_with_corruption = function(_arg, cb) {
    var armored, esc, generate_inner_arg, hooks, id, inner, links, o, opts, out, outer, outer_unpacked, pgp, proof, raw, res, s, short_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  ...
  exports.Forge = Forge = (function() {
    ...
    Forge.prototype._populate_proof = function(_arg) {
      ...
      proof.expire_in = this._get_expire_in({
        obj: linkdesc
      });
      return proof.ignore_if_unsupported = linkdesc.ignore_if_unsupported;
    };
    ...
    Forge.prototype._forge_subkey_link = function(_arg, cb) {
      var arg, err, esc, key, linkdesc, parent, proof, ref, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      linkdesc = _arg.linkdesc;
    ...
    Forge.prototype._forge_sibkey_link = function(_arg, cb) {
      var arg, err, esc, key, linkdesc, proof, ref, signer, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      linkdesc = _arg.linkdesc;
