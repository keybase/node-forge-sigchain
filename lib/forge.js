...
(function() {
  var Forge, Key, Link, akatch, createHash, iced, kbpgp, make_esc, proofs, unix_time, __iced_k, __iced_k_noop, _ref;
  ...
  exports.Forge = Forge = (function() {
    ...
    Forge.prototype._make_key = function(_arg) {
      ...
      this._keyring[k.get_ekid().toString('hex')] = k;
      return k;
    };
    ...
    Forge.prototype._init = function(cb) {
      var e, err, t;
      try {
        this._start = (t = this.chain.time) != null ? this._compute_time(t) : this._compute_now();
        this._expires = this.chain.expires || 60 * 60 * 24 * 364 * 10;
        this._user = this.chain.user || "tester_ralph";
      } catch (_error) {
        e = _error;
        err = e;
      }
    ...
    Forge.prototype._sign_and_commit_link = function(_arg, cb) {
      var generate_res, link, linkdesc, proof, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      linkdesc = _arg.linkdesc, proof = _arg.proof;
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              _this.chain.output(JSON.stringify(link), __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
