...
(function() {
  ...
  generate_v2_with_corruption = function(_arg, cb) {
    var armored, esc, generate_inner_arg, hooks, id, inner, o, opts, out, outer, pgp, proof, raw, s, short_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  ...
  Link = (function() {
    ...
    Link.prototype.get_payload_hash = function() {
      return createHash('sha256').update(this.generate_res.outer || this.inner_payload_json_str()).digest('hex');
    };
