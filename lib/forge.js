...
(function() {
  ...
  generate_v2_with_corruption = function(_arg, cb) {
    var armored, esc, generate_inner_arg, hooks, id, inner, links, new_outer, o, opts, out, outer, outer_unpacked, pgp, proof, raw, s, short_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      return function() {
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            ...
            new_outer = typeof hooks.post_generate_outer === "function" ? hooks.post_generate_outer({
              links: links,
              proof: proof,
              outer: outer,
              inner: inner
