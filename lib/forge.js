...
(function() {
  var Forge, Key, Keyring, Link, SIG_ID_SUFFIX, UID_HEX_LEN, UID_SUFFIX, akatch, athrow, createHash, iced, kbpgp, make_esc, proofs, unix_time, username_to_uid, __iced_k, __iced_k_noop, _ref;
  ...
  Link = (function() {
    ...
    Link.prototype.to_json = function() {
      if ((this.linkdesc.version === 2) && this.linkdesc.compact) {
        return this.to_json_compact();
      } else {
        return this.to_json_full();
      }
    };

    Link.prototype.to_json_compact = function() {
      return {
        c2: this.generate_res.outer.toString('base64')
      };
    };
