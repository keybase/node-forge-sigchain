...
(function() {
  ...
  exports.Forge = Forge = (function() {
    ...
    Forge.prototype._forge_revoke_link = function(_arg, cb) {
      var a, args, arr, esc, k, key, linkdesc, proof, revoke, sig_id, signer, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _len;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      linkdesc = _arg.linkdesc;
      esc = make_esc(cb, "_forge_sibkey_link");
      signer = this._keyring.label[linkdesc.signer];
      revoke = {};
      args = {
        sig_eng: signer.km.make_sig_eng(),
        revoke: revoke
      ...
      if ((key = linkdesc.revoke.key) != null) {
        revoke.kid = this._keyring.label[key].get_kid();
      } else if ((arr = linkdedsc.revoke.keys) != null) {
        revoke.kids = [];
        for (_i = 0, _len = arr.length; _i < _len; _i++) {
          a = arr[_i];
          if ((k = this._keyring.label[a].get_kid()) != null) {
            revoke.kids.push(k);
          }
        }
      } else if ((sig_id = libkdesc.revoke.sig) != null) {
        revoke.sig_id = this._link_tab[sig_id].get_sig_id();
      }
